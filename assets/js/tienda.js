...
(function () {
  ...
  function pagar(datos) {
    ...
    // El mismo tope que /pedido en el worker: avisar aquí y no después del clic.
    if (lineas.length > 100) {
      cerrarCheckout();
      avisar('Un pedido admite hasta 100 productos distintos. Divide tu carrito en dos pedidos ' +
        'o escríbenos por WhatsApp al +52 55 7563 9255.', true);
      return;
    }
